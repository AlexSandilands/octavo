...
- **Cover elements** (content v7) — optional section-preview lists, independent story teasers, issue details and resizable library logos on plain or photographic covers. A compact bottom bar exposes per-element placement, width, alignment and contrast; existing headings/text can also be positioned independently. Section references follow heading edits and pagination, with custom cover-title overrides. Phone layouts reflow into reading order; editor warnings flag collisions, overflow and missing references. All edits support history and autosave.
