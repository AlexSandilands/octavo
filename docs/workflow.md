...
| Discussion storage / module           | `npx tsx --tsconfig scripts/tsconfig.json scripts/check-member-name.mts` and `… scripts/check-comments-module.mts` — name rules, refusals, read shapes, reports, removal policies, avatars; own rows only (#299)                                              |
