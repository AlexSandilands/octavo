...
| Magazine editor toolbar               | `npx tsx --tsconfig scripts/tsconfig.json scripts/prod-editor-toolbar-gate.mts <base-url>` against a **production build** — both positions, page reserve, PDF panel and the cover inspector's two modes (#259, #268) |
