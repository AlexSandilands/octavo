...
try {
  ...
  // The create writes the draft and navigates into the editor. Wait on the
  // editor itself rather than a navigation event: it arrives as a router
  // transition, with no page load to wait for.
