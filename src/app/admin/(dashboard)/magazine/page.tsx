...
// that used to need a redeploy — what it calls itself and how its page chrome
// is set — plus the logo library the footer's mark comes from. They
  ...
  return (
    <div className="pb-16">
      ...
      <p className="text-faint mt-1.5 font-sans text-sm">
        What the magazine calls itself, how its pages are framed, and whether
        members can download an issue. Changes go live as soon as you save —
