  ...
  return (
    <main className="mx-auto max-w-5xl px-5 py-6 sm:px-8 sm:py-10">
      ...
      <section className="mt-10 flex flex-col gap-10 sm:flex-row">
        <div className="bg-hairline aspect-[5/7] w-full max-w-[320px] flex-none animate-pulse rounded-[4px]" />
        <div className="flex-1 pt-4">
          <div className="bg-hairline h-4 w-28 animate-pulse rounded-ui" />
          <div className="bg-hairline mt-5 h-10 w-3/4 animate-pulse rounded-ui" />
          <div className="bg-hairline mt-4 h-4 w-1/2 animate-pulse rounded-ui" />
          <div className="bg-hairline mt-10 h-4 w-24 animate-pulse rounded-ui" />
          <div className="mt-4 space-y-3">
            <div className="bg-hairline h-5 w-2/3 animate-pulse rounded-ui" />
            <div className="bg-hairline h-5 w-1/2 animate-pulse rounded-ui" />
            <div className="bg-hairline h-5 w-3/5 animate-pulse rounded-ui" />
          </div>
        </div>
      </section>
