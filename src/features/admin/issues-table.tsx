...
import { ISSUE_COLS, IssueRow, type IssueRowData } from "./issue-row";
    ...
    <div className={ADMIN_LIST_TABLE}>
      ...
      {rows.length > 0 && (
        <TableHead>
          ...
          <span className={ISSUE_COLS.status}>Status</span>
          <span className={`text-right ${ISSUE_COLS.actions}`}>Actions</span>
        </TableHead>
      )}
