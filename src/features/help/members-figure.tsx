  ...
  return (
    <div className="border-line-soft flex items-center gap-2.5 border-b px-4 py-2.5 last:border-b-0">
      ...
      <span className="min-w-0 flex-1">
        <span className="text-ink block truncate font-ui text-[12.5px] font-semibold">
          {name}
        </span>
        <span className="text-faint block truncate font-ui text-[10.5px]">
          {email}
        </span>
      </span>
      ...
      <span className="flex w-[96px] flex-none items-center gap-1.5">
        ...
        <span className="text-muted flex items-center gap-1 font-ui text-[11px] font-medium">
        ...
        <div className="border-line bg-paper min-w-[460px] overflow-hidden rounded-lg border">
          <div className="border-line flex items-center justify-between gap-2 border-b px-4 py-2.5">
            ...
            <div className="flex flex-none items-center gap-2">
              <FigureBadge n={2} />
              <span className="border-hair text-ink flex items-center gap-1.5 rounded-md border bg-white px-2.5 py-1.5 font-ui text-[11.5px] font-semibold">
