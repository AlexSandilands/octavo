  ...
  return (
    <FigureFrame caption="The confirmation window up close. The numbers match the list below.">
      <div className="bg-card mx-auto w-full max-w-[440px] rounded-[10px] p-5 shadow-[0_10px_30px_rgba(0,0,0,0.18)] sm:p-6">
        <div className="text-accent font-ui text-[9.5px] font-semibold tracking-[0.2em] uppercase">
          Publish &amp; send
        </div>
        ...
        <div className="mt-4 flex items-center justify-end gap-2">
          ...
          <span className="bg-accent text-paper flex items-center gap-1.5 rounded-md px-3 py-1.5 font-ui text-[12px] font-semibold">
