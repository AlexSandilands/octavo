...
export function OverflowNotice({
  ...
  return (
    <div
      ...
      style={{ top }}
    >
      <div className="border-caution border-t border-dashed" />
      <div className="flex justify-end">
        <div
          role="status"
          className="bg-caution text-paper pointer-events-auto flex items-center gap-2 rounded-b px-2 py-0.5 shadow-[0_4px_14px_rgba(40,36,28,0.16)]"
        >
          ...
          {action && (
            <button
              ...
              className="bg-paper text-caution hover:bg-page focus-visible:outline-paper my-0.5 rounded-[4px] px-2 py-1 font-ui text-[10px] font-semibold focus-visible:outline-2 focus-visible:outline-offset-2"
            >
              {action.label}
            </button>
          )}
