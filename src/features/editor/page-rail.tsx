...
export function PageRail({
  ...
  return (
    <div className="bg-card border-line flex w-[150px] flex-none flex-col items-center border-r py-4">
      <span className="text-faint w-full pl-[18px] font-sans text-[14px] font-semibold">
