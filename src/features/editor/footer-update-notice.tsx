...
export function FooterUpdateNotice({
  ...
  return (
    <div className="border-hairline bg-newsprint flex flex-wrap items-center justify-between gap-x-6 gap-y-3 border-b px-6 py-3">
      <p className="text-lead max-w-[70ch] font-ui text-[13px] leading-relaxed">
