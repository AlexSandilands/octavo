...
export function ReaderControls({
  ...
  return (
    <div className="group absolute inset-x-0 bottom-0 flex justify-center px-4 pt-12 pb-4">
      <div className="index-reader-dock bg-reader-chrome text-reader-chrome-text flex items-center gap-1.5 rounded-none px-2.5 py-2 shadow-[0_8px_24px_rgba(0,0,0,0.28)] transition-opacity duration-200 group-hover:opacity-100 group-focus-within:opacity-100">
        <CtrlBtn onClick={onPrev} title="Previous">
          <Icon name="chevronLeft" size={18} strokeWidth={1.7} />
        </CtrlBtn>
        <span className="text-reader-chrome-muted min-w-[76px] text-center font-mono text-[13px]">
          {label}
        </span>
