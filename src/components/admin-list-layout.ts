...
export const ADMIN_LIST_TABLE =
  "mt-10 flex flex-col sm:mt-13 md:mt-5 md:min-h-0 md:flex-1";
...
// padded back down: it sits where it did at rest and, once stuck, its ground
...
export const ADMIN_LIST_TOOLBAR =
  "bg-ground sticky -top-5 z-10 -mt-5 flex flex-col gap-3 pt-5 pb-3 sm:-top-8 sm:-mt-8 sm:pt-8 md:static md:mt-0 md:flex-none md:pt-0 md:pb-0 lg:flex-row";
...
export const ADMIN_LIST_ROWS =
  "scrollbar-soft relative [--scrollbar-surface:var(--color-ground)] md:-mx-8 md:-mb-8 md:min-h-48 md:flex-1 md:overflow-y-auto md:px-8 md:pb-8 md:[scrollbar-gutter:stable]";
