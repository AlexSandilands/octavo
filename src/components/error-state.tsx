...
export function ErrorState({
  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-5 py-12">
      <div className="bg-card border-line flex min-h-[420px] w-full max-w-xl flex-col rounded-[24px] border p-8 sm:p-10 shadow-[0_1px_3px_rgba(0,0,0,0.07)]">
        <Wordmark size={18} />
        <div className="my-auto">
          <p className="text-accent font-serif text-[15px] italic">{kicker}</p>
          <h1 className="text-ink mt-3 font-sans text-4xl font-semibold leading-[1.1]">
            {title}
          </h1>
